...
namespace Cloudinary {
	...
	class SearchTest extends PHPUnit_Framework_TestCase {
		...
		public function test_should_add_next_cursor_as_array() {
			...
			$this->assertEquals( $query, array( "next_cursor" => 'ec471a97ba510904ab57460b3ba3150ec29b6f8563eb1c10f6925ed0c6813f33cfa62ec6cf5ad96be6d6fa3ac3a76ccb' ) );
		...
		public function test_execute_with_params() {
			...
			assertJson( $this, json_encode( array(
			                                ...
			                                ) ), json_encode( Curl::$instance->getopt( CURLOPT_HTTPHEADER ) ), "Should use right headers for execution of advanced search api" );
		}
	}
}