...
class JsonManipulator
{
    ...
    {
        $this->makeRepositoriesArrayAnObject();

        return $this->addSubNode('repositories', $name, $config);
    }

    protected function makeRepositoriesArrayAnObject()
    {
        $json = JsonFile::parseJson($this->getContents());

        $repositories = Arr::get($json, 'repositories', []);
        ...
        $this->contents = $this->format($json);
    }
