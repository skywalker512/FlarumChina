          ...
          (function () {
            ...
            var makeSuggestion = function makeSuggestion(key) {
              ...
              return m(
                ...
                m('img', { alt: code, title: code, 'class': 'emoji', draggable: 'false', src: '//cdn.jsdelivr.net/emojione/assets/png/' + imageName + '.png' }),
                key
              );
            };
